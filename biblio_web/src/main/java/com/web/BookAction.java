...
public class BookAction extends BaseAction {
	...
	/**
	 * Represente le titre du livre recherché dans la vue contenant un formulaire de
	 * recherche par titre
	 */
	private String searchedBook;

	/**
	 * Représente la liste des thèmes, cette liste est utilisée pour construire un
	 * combobox contenant les noms des thèmes dans les vues
	 */
	...
	/**
	 * Une reference au service métier responsable sur la gestion des livres. Spring
	 * injectera automatiquement une instance de bookServiceImpl dans cette varibale
	 ...
	 * @return
	 */
	@Action(value = "showFormUpdate", results = {
			@Result(name = "updateform", location = "/pages/formModifyBook.jsp") })
	...
	/**
	 * Méthode d'action utilisée pour initialiser le formulaire d'ajout d'un livre
	 * 
	 * @return
	 */
	...
	@Actions( {
		@Action(value = "/", 
				results = { 
						@Result(
								location = "/pages/form.jsp") 
						}),
		@Action(value = "showFormAdd",
				results = { 
						@Result(name = "saveform",
								location = "/pages/form.jsp") })
	...
	@Action(value = "addBook", results = {
			@Result(name = "success", type = "redirect", location = "listAction"),
			@Result(name = "input", location = "/pages/form.jsp") })
	...
	@Action(value = "updateBook", results = { @Result(name = "success", location = "/pages/formModifyBook.jsp"),
			@Result(name = "input", location = "/pages/formModifyBook.jsp") })
	 ...
	 * @return
	 */
	@Action(value = "deleteBook", results = { @Result(name = "success", type = "redirect", location = "listAction") })
	 ...
	 */
	@Action(value = "searchAction", results = { @Result(name = "success", location = "/pages/list.jsp") })
